...
//-------------------------------------------------
    showHelpTip: function () {
        ...
        dbox.innerContainer.innerHTML = "<p style='clear: both; margin: 3px 0 0 0;'><img src='https://raw.githubusercontent.com/eddeyang/BrowserCodeSnippets/master/aardvarkhelp.gif' style=' float: right; margin: 0 0 0px 0'>" + this.strings.initialTipText + "</p>";
...
// this is the main entry point when starting aardvark
    start: function () {
        ...
        if (this.doc.aardvarkRunning) {
            ...
            $(this.doc).on("mouseover", this.mouseOver);
            $(this.doc).on("mousemove", this.mouseMove);
            $(this.doc).on("mouseup", this.mouseUp);
            $(this.doc).on("keypress", this.keyDown);
...
// outerDiv.style.visibility = "hidden";
    ...
    outerDiv.style.top = "-5000px";
    /* (dims.scrollY + 5) + "px"; */
    outerDiv.style.left = "-5000px";
    /* (dims.scrollX + 5) + "px"; */
    ...
    if (dragger) {
        ...
        closer.src = "https://raw.githubusercontent.com/eddeyang/BrowserCodeSnippets/master/closedbox.gif";
